...
namespace EmPrep
{
    public partial class MapKitViewController1 : UIViewController
    {
        public MapKitViewController1 (IntPtr handle) : base (handle)
        {
		}
		...
		public override void ViewDidLoad()
		{
			...
			mapView.Delegate = new MapDelegate1(this);
	...
	public class MapDelegate1 : MKMapViewDelegate
	{
		protected string annotationIdentifier = "BasicAnnotation";
		UIButton detailButton;
		MapKitViewController1 parent;

		public static int color = 1;
		public MapDelegate1(MapKitViewController1 parent)
		{
			this.parent = parent;
		}
		/// <summary>
